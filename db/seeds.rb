...
r145 = Rhythm.where(rhythm_str: "x--x-x--x--x---x-x-").first_or_create!(creator_id: u1.id, rhythm_str: "")
...
#
# # r??? = Rhythm.where(rhythm_str: "").first_or_create!(creator_id: u1.id, rhythm_str: "")
